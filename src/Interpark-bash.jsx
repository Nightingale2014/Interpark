...
import './components/Header.css'; // css 파일을 제대로 연결
import searchIcon from './assets/images/search-icon.png'; // import 문
    ...
    <div>
      <header className="header">
        ...
        <div className="top-menu">
          {/* 로고와 텍스트 */}
          <div className="logo">
            <img src="/images/interpark-logo.png" alt="Interpark Logo" />
            <span>Interpark</span>
          </div>
